...
;DOES THIS WORK?!
CLR_CompileF#(Code, References="", AppDomain=0, FileName="", CompilerOptions="")
{
	return CLR_CompileAssembly(Code, References, "System", "Microsoft.FSharp.Compiler.CodeDom.FSharpCodeProvider", AppDomain, FileName, CompilerOptions)
}
